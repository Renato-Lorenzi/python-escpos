...
class Usb(Escpos):
    ...
    def __init__(self, idVendor, idProduct, timeout=None, in_ep=0x82, out_ep=0x01, *args, **kwargs):
        """
        :param idVendor: Vendor ID
        :param idProduct: Product ID
        :param timeout: Is the time limit of the USB operation. Default None takes the pyusb default value (1000)
